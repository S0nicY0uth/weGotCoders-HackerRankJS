//details of the problem solved below can be found here...https://www.hackerrank.com/challenges/ctci-making-anagrams/problem
...
function main() {
   ...
   var arraylengths = arraya.length + arrayb.length;
    ...
    if (thenumber > -1) {
        var index = thenumber;
        delete longestarray[index]; // <-- less costly than splice
        subtract = subtract + 2;
    }
}
